/**
 * @name BrainCryptLoader
 * @version 1.2
 * @description Loads BrainCrypt
 * @author Marni
 */
...
var BrainCryptLoader = (() => {
  ...
  function Start() {
      if(!Initialized) {
          ...
          iframe.onload = () => {
              ...
              require('https').get("https://raw.githubusercontent.com/Braincell-Industries/BrainCrypt/main/BrainCrypt.user.js", (response) => {
                  let data = [];
  ...
  module.exports = BrainCryptLoader;
