...
(function () {
  ...
  <div class="sdc-overlay">
    ...
    var Utils = {
      Log: message => {
        console.log(`%c[BrainCrypt] %c${message}`, `color:${BaseColor};font-weight:bold`, '');
      },
      Warn: message => {
        console.warn(`%c[BrainCrypt] %c${message}`, `color:${BaseColor};font-weight:bold`, '');
      },
      Error: message => {
        console.error(`%c[BrainCrypt] %c${message}`, `color:${BaseColor};font-weight:bold`, '');
      },
      Webpack: function () {
    ...
    async function handleUpdate(event) {
      ...
      if (message.content == null && message.embeds != null && message.embeds.length === 1) {
        ...
        if (
          embed.footer != null &&
          (embed.footer.text === 'BrainCrypt' || embed.footer.text === "Very Cryptic, Isn't it...")
        ) {
      ...
      if (
        ...
        message.embed = {
          ...
          author: {
            ...
            url: 'https://github.com/Braincell-Industries/BrainCrypt',
          },
          description: payload,
          footer: {
